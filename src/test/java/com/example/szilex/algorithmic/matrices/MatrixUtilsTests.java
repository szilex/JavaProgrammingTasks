...
public class MatrixUtilsTests {
    ...
    void testSingleElementMatrix() {
        ...
        Assertions.assertEquals(1, MatrixUtils.calculateDeterminant(matrix));
    }

    @Test
    void testTwoByTwoElementMatrix() {
        int[][] matrix = new int[][] {{1, 2}, {3, 4}};
        Assertions.assertEquals(-2, MatrixUtils.calculateDeterminant(matrix));
    }

    @Test
    void testThreeByThreeElementMatrix() {
        int[][] matrix = new int[][] {{1, 2, 3}, {4, 5, 6}, {7, 8, 9}};
        Assertions.assertEquals(0, MatrixUtils.calculateDeterminant(matrix));
    }

    @Test
    void testThreeByThreeNegativeElementMatrix() {
        int[][] matrix = new int[][] {{1, -2, -3}, {-4, -5, 6}, {7, -8, 9}};
        Assertions.assertEquals(-354, MatrixUtils.calculateDeterminant(matrix));
    }
    ...
    void testFiveByFiveElementMatrix() {
        ...
        Assertions.assertEquals(-1959, MatrixUtils.calculateDeterminant(matrix));
    }
}
